...
[Go to Chinese version](https://github.com/xzeu/tz/blob/main/docs/zh/tutorial.md)

# Tz Framework User Guide

Tz is a web framework based on the Go programming language. It provides an elegant project structure and command operations that allow developers to efficiently develop web applications.

## Requirements
To use Tz with Advanced Layout, you need to have the following software installed on your system:
...
Before you can start using Tz, you need to install it. You can do so by running the following command:
...
> tips: If `go install` is successful but you get an error saying "tz command not found," it means that the environment variable is not configured. You can add the GOBIN directory to the environment variable.

## Creating a Project

Creating a new project with Tz is very simple. Just run the following command in the command line:
...
By default, `tz new` pulls from the GitHub repository, but you can also use an accelerated repository in China.
...
After running the above command, Tz will automatically create a well-structured Go project with some commonly used files and directories.


## Creating Components

In Tz, you can use the following command to create Handler, Service, Repository, and Model components in batches:
...
After running the above command, Tz will automatically create the components in the corresponding directories and write the corresponding structures and some commonly used methods.
```
// Log information
...
In Tz, you can use the following command to compile Wire:
...
At this point, we have completed the core process of the Tz project.
...
Finally, in Tz, you can use the following command to start the project:
...
After running the above command, Tz will automatically start the project and monitor file updates, supporting hot-reloading.
...
The Tz framework provides an elegant project structure and command operations that allow developers to efficiently develop web applications. In this tutorial, you have learned how to create a project, create Handlers, create Services, create Repositories, compile Wire, and start the project using Tz. We hope that this content will help you make better use of the Tz framework.
